...
namespace Project06.Controllers
{
    public class TipoClienteController : Controller
    {
        ...
        public ActionResult InsertaTipoCliente(TipoClienteModel modeloVista)
        {
            ...
            string descripcion = modeloVista.descripcionTipoCliente;
        ...
        public ActionResult TipoClienteElimina(int id_Persona)
        {
            ///obtener el registro que se desea modificar
            ///utilizando el parámetro del método id_Persona
            sp_RetornaTipoClienteID_Result modeloVista = new sp_RetornaTipoClienteID_Result();
            modeloVista = this.modeloBD.sp_RetornaTipoClienteID(id_Persona).FirstOrDefault();
