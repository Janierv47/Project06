...
namespace Project06.Models
{
    ...
    public partial class proyecto06Entities : DbContext
    {
        ...
        public DbSet<tblTransferencia> tblTransferencia { get; set; }
        ...
        public virtual int sp_Deposito(Nullable<int> id_TipoMovimiento, Nullable<int> id_Cuenta, Nullable<double> monto, Nullable<int> fechaDelMovimiento)
        {
            ...
            var fechaDelMovimientoParameter = fechaDelMovimiento.HasValue ?
                ...
                new ObjectParameter("fechaDelMovimiento", typeof(int));
        ...
        public virtual int sp_InsertCliente(Nullable<int> id_tipoCliente, Nullable<int> cedula, string genero, Nullable<System.DateTime> fechaNacimiento, string primerApellido, string segundoApellido, string nombre, string direccionFisica, string telefonoPrincipal, string telefonoSecundario, string correo, string claveAcceso)
        {
            var id_tipoClienteParameter = id_tipoCliente.HasValue ?
                new ObjectParameter("id_tipoCliente", id_tipoCliente) :
                new ObjectParameter("id_tipoCliente", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_InsertCliente", id_tipoClienteParameter, cedulaParameter, generoParameter, fechaNacimientoParameter, primerApellidoParameter, segundoApellidoParameter, nombreParameter, direccionFisicaParameter, telefonoPrincipalParameter, telefonoSecundarioParameter, correoParameter, claveAccesoParameter);
        }
        ...
        public virtual int sp_RetornaCliente(string primerApellido, string segundoApellido, string nombre, string correo, string claveAcceso)
        {
            var primerApellidoParameter = primerApellido != null ?
                new ObjectParameter("primerApellido", primerApellido) :
                new ObjectParameter("primerApellido", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RetornaCliente", primerApellidoParameter, segundoApellidoParameter, nombreParameter, correoParameter, claveAccesoParameter);
        }
    
        public virtual int sp_RetornaClienteID(Nullable<int> id_cliente)
        {
            var id_clienteParameter = id_cliente.HasValue ?
                new ObjectParameter("id_cliente", id_cliente) :
                new ObjectParameter("id_cliente", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RetornaClienteID", id_clienteParameter);
        }
        ...
        public virtual ObjectResult<sp_RetornaMoneda_Result> sp_RetornaMoneda(string nombre, string codigo)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("nombre", nombre) :
                new ObjectParameter("nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_RetornaMoneda_Result>("sp_RetornaMoneda", nombreParameter, codigoParameter);
        }
        ...
        public virtual int sp_UpdateCliente(Nullable<int> id_cliente, Nullable<int> id_tipoCliente, Nullable<int> cedula, string genero, Nullable<System.DateTime> fechaNacimiento, string primerApellido, string segundoApellido, string nombre, string direccionFisica, string telefonoPrincipal, string telefonoSecundario, string correo, string claveAcceso)
        {
            var id_clienteParameter = id_cliente.HasValue ?
                new ObjectParameter("id_cliente", id_cliente) :
                new ObjectParameter("id_cliente", typeof(int));
