...
namespace Project06.Models
{
    ...
    public partial class proyecto06Entities : DbContext
    {
        ...
        public virtual int sp_Deposito(Nullable<int> id_TipoMovimiento, Nullable<int> id_Cuenta, Nullable<double> monto, Nullable<System.DateTime> fechaDelMovimiento, Nullable<int> id_moneda)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Deposito", id_TipoMovimientoParameter, id_CuentaParameter, montoParameter, fechaDelMovimientoParameter, id_monedaParameter);
        }
        ...
        public virtual int sp_InsertCuenta(Nullable<int> numeroCuenta, Nullable<int> id_Cliente, Nullable<int> id_tipoCuenta, Nullable<int> id_moneda)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_InsertCuenta", numeroCuentaParameter, id_ClienteParameter, id_tipoCuentaParameter, id_monedaParameter);
        }
        ...
        public virtual int sp_Retiro(Nullable<int> id_Cuenta, Nullable<double> monto, Nullable<System.DateTime> fechaDelMovimiento, Nullable<int> id_moneda)
        {
            var id_CuentaParameter = id_Cuenta.HasValue ?
                new ObjectParameter("id_Cuenta", id_Cuenta) :
                new ObjectParameter("id_Cuenta", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Retiro", id_CuentaParameter, montoParameter, fechaDelMovimientoParameter, id_monedaParameter);
        }
        ...
        public virtual ObjectResult<sp_RetornaCuentas_Result> sp_RetornaCuentas()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_RetornaCuentas_Result>("sp_RetornaCuentas");
        }
    
        public virtual ObjectResult<sp_RetornaMoneda_Result> sp_RetornaMoneda()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_RetornaMoneda_Result>("sp_RetornaMoneda");
        }
        ...
        public virtual ObjectResult<sp_AutenticacionUsuario_Result> sp_AutenticacionUsuario(string usuario, Nullable<int> clave)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_AutenticacionUsuario_Result>("sp_AutenticacionUsuario", usuarioParameter, claveParameter);
        }
    
        public virtual ObjectResult<sp_RetornaCliente_Result> sp_RetornaCliente()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_RetornaCliente_Result>("sp_RetornaCliente");
        }
    
        public virtual ObjectResult<sp_RetornaTipoCuenta_Result> sp_RetornaTipoCuenta()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_RetornaTipoCuenta_Result>("sp_RetornaTipoCuenta");
        }
